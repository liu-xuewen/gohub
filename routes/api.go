...
import (
	controllers "github.com/liu-xuewen/gohub/app/http/controllers/api/v1"
	"github.com/liu-xuewen/gohub/app/http/controllers/api/v1/auth"
	"github.com/liu-xuewen/gohub/app/http/middlewares"
